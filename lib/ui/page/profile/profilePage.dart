...
import 'package:academiaspace/state/profile_state.dart';
import 'package:academiaspace/ui/page/profile/EditProfilePage.dart';
...
import 'package:academiaspace/ui/page/profile/profileImageView.dart';
...
import 'package:academiaspace/ui/page/profile/widgets/tabPainter.dart';
...
import 'package:academiaspace/widgets/tweet/widgets/tweetBottomSheet.dart';
    ...
    Utility.createLinkAndShare(
      ...
      socialMetaTagParameters: SocialMetaTagParameters(
        description: !user.bio!.contains("Edit profile")
            ? user.bio
            : "Checkout ${user.displayName}'s profile on AcademiaSpace app",
        title: "${user.displayName} is on AcademiaSpace app",
            ...
            ? Container(
                ...
                child: NotifyText(
                  title: isMyProfile
                      ...
                      : '${authState.profileUserModel.userName} hasn\'t ${isReply ? 'reply to any Post' : isMedia ? 'post any media yet' : 'post any Post yet'}',
                  subTitle: isMyProfile
                      ? '${isReply ? 'Your comments will show up here' : isMedia ? 'Your medias will show up here' : 'Tap post button to add new'}'
...
class UserNameRowWidget extends StatelessWidget {
  ...
  String getUniversity(String university) {
    if (isMyProfile) {
      return university;
    } else if (university == "No university") {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 9),
          child: customText(
            'UNIVERSITY :  ' + getUniversity(user.university!) + '-BENIN',
            style: TextStyles.subtitleStyle.copyWith(fontSize: 13),
          ),
        ),
        Padding(
