      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          const SettingRowWidget(
            ...
            showDivider: false,
            subtitle:
                'When enabled, video won\'t autoplay and lower-quality images load. This automatically reduces your data usage for all AcademiaSpace accounts on this device.',
            visibleSwitch: null,
          ),
          const Divider(height: 0),
          ...
          const SettingRowWidget(
            null,
            subtitle:
                'Allow AcademiaSpace to sync data in the background to enhance your experience.',
            vPadding: 10,
            showCheckBox: null,
            visibleSwitch: null,
          ),
