      ...
      body: ListView(
        ...
        children: const <Widget>[
          ...
          SettingRowWidget(
            "Precise location",
            subtitle:
                'Disabled \n\n\nIf enabled, AcademiaSpace will collect, store, and use your device\'s precise location, such as your GPS information. This lets AcademiaSpace improve your experience - for example, showing you mpre local content, ads, and recommendations.',
          ),
          HeaderWidget(
