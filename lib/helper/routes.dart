...
import 'package:academiaspace/ui/page/Auth/selectAuthMethod.dart';
import 'package:academiaspace/ui/page/Auth/verifyEmail.dart';
import 'package:academiaspace/ui/page/common/splash.dart';
import 'package:academiaspace/ui/page/feed/composeTweet/composeTweet.dart';
import 'package:academiaspace/ui/page/feed/composeTweet/state/composeTweetState.dart';
import 'package:academiaspace/ui/page/homePage.dart';
import 'package:academiaspace/ui/page/message/conversationInformation/conversationInformation.dart';
import 'package:academiaspace/ui/page/message/newMessagePage.dart';
import 'package:academiaspace/ui/page/profile/follow/followerListPage.dart';
import 'package:academiaspace/ui/page/search/SearchPage.dart';
import 'package:academiaspace/ui/page/settings/accountSettings/about/aboutTwitter.dart';
import 'package:academiaspace/ui/page/settings/accountSettings/accessibility/accessibility.dart';
import 'package:academiaspace/ui/page/settings/accountSettings/accountSettingsPage.dart';
import 'package:academiaspace/ui/page/settings/accountSettings/contentPrefrences/contentPreference.dart';
import 'package:academiaspace/ui/page/settings/accountSettings/contentPrefrences/trends/trendsPage.dart';
import 'package:academiaspace/ui/page/settings/accountSettings/dataUsage/dataUsagePage.dart';
import 'package:academiaspace/ui/page/settings/accountSettings/displaySettings/displayAndSoundPage.dart';
import 'package:academiaspace/ui/page/settings/accountSettings/notifications/notificationPage.dart';
import 'package:academiaspace/ui/page/settings/accountSettings/privacyAndSafety/directMessage/directMessage.dart';
import 'package:academiaspace/ui/page/settings/accountSettings/privacyAndSafety/privacyAndSafetyPage.dart';
import 'package:academiaspace/ui/page/settings/accountSettings/proxy/proxyPage.dart';
import 'package:academiaspace/ui/page/settings/settingsAndPrivacyPage.dart';
